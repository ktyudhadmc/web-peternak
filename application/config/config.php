...
$config['cdn_url'] = "https://cdn.peternak.id/";
$config['assets_url'] = "https://assets.peternak.id/";
$config['app_url'] = "https://peternak.id/";
$config['api_url'] = $prot == 'https://' ?  "https://api.peternak.id/" : "http://peternak_api.test/";
