...
<div class="col-xxl-12">
    <!--begin::Table-->
    <div id="none_sensorchart_weighing" class="card card-flush h-lg-100" style="align-items: center;padding-bottom: 50px;">
        ...
        <div class="fs-6 text-gray-400" id="ket_notif_sensor_weighing">Pilih lokasi dan jenis sensor</div>
    </div>
    <!--begin::Card header-->
    <div id="chartloadingsensor_weighing" class="card card-flush h-lg-100" style="align-items: center;padding-bottom: 50px;display:none">
    ...
    <div class="card card-flush" id="chartviewsensor_weighing" style="display:none">

        <div class="card-header mt-4" style="min-height: 50px;">
            <div class="card-title flex-column">
                <div class="d-flex align-items-center mb-1">
                    <h3 class="fw-bolder mb-0" id="tittle_sensorchart_weighing">Chart Sensor</h3>
                </div>
                <div class="d-flex flex-wrap fw-bold mb-4 fs-5 text-gray-400" id="tittle_sensorchart_weighing_total">
                    Total Water *** L
                </div>
            </div>
            <div class="card-toolbar" style="margin-top: -20px;">
                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modal_sensorchart_weighing"><i class="fas fa-search white-true"></i>&nbsp;Tabel </a>
            </div>
        </div>
        <!--end::Card header-->
        <!-- <div class="card-body">
        ...
        <div class="card-body pt-5 pb-0 px-5">
            <!--begin::Chart-->
            <div id="kt_sensorchart_weighing" style="min-height: 200px;"></div>
            <!-- <div id="kt_project_overview_graph" class="card-rounded-bottom" style="height: 300px"></div> -->
            <!--end::Chart-->
        </div>
        <div class="card-body pt-5 pb-0 px-5">
            <!--begin::Chart-->
            <div id="kt_sensorchart_line_weighing" style="min-height: 50px;"></div>
            <!-- <div id="kt_project_overview_graph" class="card-rounded-bottom" style="height: 300px"></div> -->
            <!--end::Chart-->
        </div>
