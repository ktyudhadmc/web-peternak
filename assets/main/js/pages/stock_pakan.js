function viewtablepemakaianpakan() {
    ...
    var tpf = $('#exampletablepemakaianpakan').DataTable({
        ...
        buttons: [{ extend: 'excel', footer: true, title: 'Pemakaian Pakan ' + lokasi + ' tanggal ' + tanggal_mulai + ' to ' + tanggal_akhir },
        { extend: 'pdf', footer: true, title: 'Pemakaian Pakan ' + lokasi + ' tanggal ' + tanggal_mulai + ' to ' + tanggal_akhir },
        { extend: 'print', footer: true, title: 'Pemakaian Pakan ' + lokasi + ' tanggal ' + tanggal_mulai + ' to ' + tanggal_akhir },
        {
            extend: 'copy',
        ...
        "ajax": {
            'type': 'POST',
            'url': base_url + 'main/stock_pakan/get_data_pemakaian_pakan',
            'data': {
                id_user: id_user,
...
function viewtabledetailpemakaianpakan() {
    ...
    var tpf = $('#exampletabledetailpemakaianpakan').DataTable({
        ...
        "ajax": {
            'type': 'POST',
            'url': base_url + 'main/stock_pakan/get_data_detail_pemakaian_pakan',
            'data': {
                id_user: id_user,
                tanggal_mulai: tanggal_mulai,
                tanggal_akhir: tanggal_akhir,
...
function viewtablestockpakan() {
    ...
    var tso = $('#exampletablestockpakan').DataTable({
        ...
        "scrollX": true,
        dom: '<"top"B>rt<"bottom"ilp><"clear">',
        buttons: [{ extend: 'excel', footer: true, title: 'Stock Pakan ' + lokasi + ' tanggal ' + tanggal_akhir },
        { extend: 'pdf', footer: true, title: 'Stock Pakan ' + lokasi + ' tanggal ' + tanggal_akhir },
        { extend: 'print', footer: true, title: 'Stock Pakan ' + lokasi + ' tanggal ' + tanggal_akhir },
        {
            extend: 'copy',
            text: 'Copy current page',
            exportOptions: {
        ...
        "ajax": {
            'type': 'POST',
            'url': base_url + 'main/stock_pakan/get_data_stock_pakan',
            'data': {
                id_user: id_user,
                tanggal_akhir: tanggal_akhir,
            },
    ...
    $.ajax
        ({
            type: 'POST',
            url: base_url + 'main/stock_pakan/kebutuhanpakan',
            data: {
                id_user: id_user,
                tanggal_akhir: tanggal_akhir,
            },
...
function viewtablekedatanganpakan() {
    ...
    var tso = $('#exampletablekedatanganpakan').DataTable({
        ...
        "scrollX": true,
        dom: '<"top"B>rt<"bottom"ilp><"clear">',
        buttons: [{ extend: 'excel', footer: true, title: 'Kedatangan Pakan ' + lokasi },
        { extend: 'pdf', footer: true, title: 'Kedatangan Pakan ' + lokasi },
        { extend: 'print', footer: true, title: 'Kedatangan Pakan ' + lokasi },
        {
            extend: 'copy',
            text: 'Copy current page',
            exportOptions: {
        ...
        "ajax": {
            'type': 'POST',
            'url': base_url + 'main/stock_pakan/get_data_kedatangan_pakan',
            'data': {
                id_user: id_user,
            },
            "dataSrc": "",
        ...
        "columns": [
          ...
          <a href="javascript:void(0);"  class="btn btn-danger btn-sm" onclick="delete_kedatangan_mutasi_pakan(`+ data + `,'stock_pakan/delete_kedatangan_pakan')"><i class="fa fa-trash"></i>&nbsp Delete</a>`;
                    }
                }
            }
        ],
...
function viewtablemutasipakan() {
    ...
    var tso = $('#exampletablemutasipakan').DataTable({
        ...
        "scrollX": true,
        dom: '<"top"B>rt<"bottom"ilp><"clear">',
        buttons: [{ extend: 'excel', footer: true, title: 'Mutasi Pakan ' + lokasi },
        { extend: 'pdf', footer: true, title: 'Mutasi Pakan ' + lokasi },
        { extend: 'print', footer: true, title: 'Mutasi Pakan ' + lokasi },
        {
            extend: 'copy',
            text: 'Copy current page',
            exportOptions: {
        ...
        "ajax": {
            'type': 'POST',
            'url': base_url + 'main/stock_pakan/get_data_mutasi_pakan',
            'data': {
                id_user: id_user,
            },
            "dataSrc": "",
...
function viewtablejenispakan() {
    ...
    var tso = $('#exampletablejenispakan').DataTable({
        ...
        "scrollX": true,
        dom: '<"top"B>rt<"bottom"ilp><"clear">',
        buttons: [{ extend: 'excel', footer: true, title: 'Jenis Pakan' },
        { extend: 'pdf', footer: true, title: 'Jenis Pakan' },
        { extend: 'print', footer: true, title: 'Jenis Pakan' },
        {
            extend: 'copy',
            text: 'Copy current page',
            exportOptions: {
        ...
        "ajax": {
            'type': 'POST',
            'url': base_url + 'main/stock_pakan/get_data_pakan',
            'data': {
                // id_user: id_user,
            },
            "dataSrc": "",
...
function add_pakan() {
    ...
    $.ajax
        ({
            type: 'POST',
            url: base_url + 'main/stock_pakan/add_pakan',
            data: {
...
function add_mutasi_pakan() {
    ...
    $.ajax
        ({
            type: 'POST',
            url: base_url + 'main/stock_pakan/add_mutasi_pakan',
            data: {
...
function edit_kedatangan_pakan() {
    ...
    $.ajax
        ({
            type: 'POST',
            url: base_url + 'main/stock_pakan/edit_kedatangan_pakan',
            data: {
...
function add_kedatangan_pakan() {
    ...
    $.ajax
        ({
            type: 'POST',
            url: base_url + 'main/stock_pakan/add_kedatangan_pakan',
            data: {
...
function edit_mutasi_pakan() {
    ...
    $.ajax
        ({
            type: 'POST',
            url: base_url + 'main/stock_pakan/edit_mutasi_pakan',
            data: {
...
function edit_jenis_pakan_query() {
    ...
    $.ajax
        ({
            type: 'POST',
            url: base_url + 'main/stock_pakan/edit_jenis_pakan',
            data: {
